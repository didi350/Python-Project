...
The project code is within Jupyter-Notebook-File. The notebook covers everything, including explanations, tables, conclusions, and some extra sections at the end. There are multiple images and functions created for this project, which are grouped under their corresponding folders. The database used consists of two CSV files, grouped with the corresponding licences under the "Datasets" folder. Both of the datasets were sourced from Kaggle; please see the Sources section at the bottom of the notebook to get to the links.
